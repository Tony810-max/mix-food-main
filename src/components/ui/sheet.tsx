...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      'data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 block bg-black/70 data-[state=closed]:animate-out data-[state=open]:animate-in lg:hidden',
      className
    )}
    {...props}
    ref={ref}
...
const sheetVariants = cva(
  'fixed z-50 gap-4 block lg:hidden bg-background p-6 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out',
  {
    variants: {
      side: {
